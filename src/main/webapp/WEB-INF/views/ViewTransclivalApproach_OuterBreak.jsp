...
<body>
              ...
              <div class="row">
                  <div class="col-sm-12">
                      <ol class="cd-breadcrumb triangle custom-icons">
                        ...
                        <li><a href="#" onclick="SeptalFlap();">Step <strong>비중격피판도안</strong></a></li>
                        <li><a href="#" onclick="SphenoidCellsRemoval();">Step <strong>접형동개방</strong></a></li>
                        <li><a href="#" onclick="TransclivalDrilling();">Step <strong>경사대드릴링</strong></a></li>
                      </ol>
                  </div>
    ...
    ================================================== -->
        ...
        function OuterBreak()
        {
        	window.location.href = "${path}/ViewTransclivalApproach_OuterBreak?id=${map.no}"; 
        }
