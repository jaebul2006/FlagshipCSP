      ...
      <main role="main">
              ...
              <div class="row">
                  <div class="col-sm-12">
                      <ol class="cd-breadcrumb triangle custom-icons">
                        ...
                        <li class="current"><a href="#" onclick="TSASeptalFlap();">Step <strong>비중격피판도안</strong></a></li>
                        ...
                        <li><a href="#" onclick="TSATumorRemoval();">Step <strong>종양 절제</strong></a></li>
                      </ol>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">비중격피판도안(SeptalFlap)</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">목록</th>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>${map.ent_tsa_septalflap_Score}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">기록</th>
                                      <td>${map.ent_tsa_septalflap_Note}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">position</th>
                                      <td>${map.ent_tsa_septalflap_Position}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">rotation</th>
                                      <td>${map.ent_tsa_septalflap_Rotation}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">scale</th>
                                      <td>${map.ent_tsa_septalflap_Scale}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">비중격피판도안(SeptalFlap) 도구 정보</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">도구 수치 목록</th>
                              ...
                              <tbody>
                                  <tr>
                                      <th scope="row">충돌횟수</th>
                                      <td>${map.ent_tsa_septalflap_Tools_TouchCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">툴 조작 횟수</th>
                                      <td>${map.ent_tsa_septalflap_Tools_ToolUseCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 정확한 툴 위치횟수</th>
                                      <td>${map.ent_tsa_septalflap_Tools_ToolInnerCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">도구 충돌 점수</th>
                                      <td>${map.ent_tsa_septalflap_Tools_ToolTouchScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 도구 위치 점수</th>
                                      <td>${map.ent_tsa_septalflap_Tools_ToolViewScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">각각 최대 툴 점수</th>
                                      <td>${map.ent_tsa_septalflap_Tools_MaxScore}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content at-height">
                          <div class="row">
                              <div class="col-md-12">
                                  <h6 class="chart-top-title">비중격피판도안(SeptalFlap) 도구 점수</h6>
                                  <ul class="chart-color-ul">
                                      <li><span class="chart-color one"></span>전문가 점수</li>
                                      <li><span class="chart-color two"></span>실습자 점수</li>
                                      <li><span class="chart-color three"></span>실습자 평균</li>
                              ...
                              <div class="first-chart">
                                  <div class="first-chart-container">
                                      ...
                                      new Chartist.Bar('#tool_septalflap_chart', {
                                          ...
                                          [${map.ent_tsa_septalflap_Tools_TouchCount}, ${map.ent_tsa_septalflap_Tools_ToolUseCount}, ${map.ent_tsa_septalflap_Tools_ToolInnerCount}, ${map.ent_tsa_septalflap_Tools_ToolTouchScore}, ${map.ent_tsa_septalflap_Tools_ToolViewScore}, ${map.ent_tsa_septalflap_Tools_MaxScore}],
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">비중격피판도안(SeptalFlap)궤적 그래프 X</h6>
                          <div class="ct-chart ct-chart-bar" id="septal_flap_chart_x"></div>
                          <script>
                          var ent_tsa_septalflap_points_x = [];
                          <c:forEach var="row" items="${map.ent_tsa_septalflap_points}">
                          	ent_tsa_septalflap_points_x.push(${row.positionA}[0]);
  						  </c:forEach>
                          
  						  var ent_tsa_septalflap_target_points_x = [];
  						  <c:forEach var="row" items="${map.ent_tsa_septalflap_target_points}">
  							ent_tsa_septalflap_target_points_x.push(${row.positionA}[0]);
						  </c:forEach>
  						  
                          new Chartist.Line('#septal_flap_chart_x', {
                              labels: [],
                              series: [
                            	  	  ent_tsa_septalflap_points_x,
                            	  	  ent_tsa_septalflap_target_points_x,
                                    ]
                          }, {
                              height: 322,
                              fullWidth: true,
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">비중격피판도안(SeptalFlap)궤적 그래프 Y</h6>
                          <div class="ct-chart ct-chart-bar" id="septal_flap_chart_y"></div>
                          <script>
                          var ent_tsa_septalflap_points_y = [];
                          <c:forEach var="row" items="${map.ent_tsa_septalflap_points}">
                          	ent_tsa_septalflap_points_y.push(${row.positionA}[1]);
  						  </c:forEach>
                          
  						  var ent_tsa_septalflap_target_points_y = [];
  						  <c:forEach var="row" items="${map.ent_tsa_septalflap_target_points}">
  							ent_tsa_septalflap_target_points_y.push(${row.positionA}[1]);
						  </c:forEach>
  						  
                          new Chartist.Line('#septal_flap_chart_y', {
                              labels: [],
                              series: [
                            	  	  ent_tsa_septalflap_points_y,
                            	  	  ent_tsa_septalflap_target_points_y,
                                    ]
                          }, {
                              height: 322,
                              fullWidth: true,
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">비중격피판도안(SeptalFlap)궤적 그래프 Z</h6>
                          <div class="ct-chart ct-chart-bar" id="septal_flap_chart_z"></div>
                          <script>
                          var ent_tsa_septalflap_points_z = [];
                          <c:forEach var="row" items="${map.ent_tsa_septalflap_points}">
                          	ent_tsa_septalflap_points_z.push(${row.positionA}[2]);
  						  </c:forEach>
                          
  						  var ent_tsa_septalflap_target_points_z = [];
  						  <c:forEach var="row" items="${map.ent_tsa_septalflap_target_points}">
  							ent_tsa_septalflap_target_points_z.push(${row.positionA}[2]);
						  </c:forEach>
  						  
                          new Chartist.Line('#septal_flap_chart_z', {
                              labels: [],
                              series: [
                            	  	  ent_tsa_septalflap_points_z,
                            	  	  ent_tsa_septalflap_target_points_z,
                                    ]
                          }, {
                              height: 322,
                              fullWidth: true,
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">Septal Flap 수술 부위 도식</h6>
          ...
          <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">단위 수술별 점수 그래프</h6>
                          <ul class="chart-color-ul">
