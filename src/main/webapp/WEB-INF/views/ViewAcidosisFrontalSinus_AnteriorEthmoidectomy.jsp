    ...
    <nav class="navbar navbar-expand-lg bg-white" id="navbar">
      ...
      <main role="main">
          <section class="sub-visual evaluation">
              <div class="container">
                  <h1 class="main-visual-heading mb-0">Acidosis Frontal Sinus</h1>
              </div>
          </section>
              ...
              <div class="row">
                  <div class="col-sm-12">
                      <ol class="cd-breadcrumb triangle custom-icons">
                        ...
                        <li class="current"><a href="#" onclick="AnteriorEthmoidectomy();">Step <strong>전사골동 개방</strong></a></li>
                        <li><a href="#" onclick="AnteriorSinus();">Step <strong>전두동 개방 및 농제거</strong></a></li>
                      </ol>
                  </div>

                  <h4 class="title-lg text-center mb-5 mt-5">전사골동 개방</h4>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">전사골동 개방</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">목록</th>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>${map.anterior_ethmoidectomy_Score}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">기록</th>
                                      <td>${map.anterior_ethmoidectomy_Note}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">Position</th>
                                      <td>${map.anterior_ethmoidectomy_Position}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">Rotation</th>
                                      <td>${map.anterior_ethmoidectomy_Rotation}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">Localcale</th>
                                      <td>${map.anterior_ethmoidectomy_Localcale}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">핀 갯수</th>
                                      <td>${map.anterior_ethmoidectomy_PinCount}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">전사골동 개방 도구 정보</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">도구 수치 목록</th>
                              ...
                              <tbody>
                                  <tr>
                                      <th scope="row">충돌횟수</th>
                                      <td>${map.anterior_ethmoidectomy_Tools_TouchCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">툴 조작 횟수</th>
                                      <td>${map.anterior_ethmoidectomy_Tools_ToolUseCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 정확한 툴 위치횟수</th>
                                      <td>${map.anterior_ethmoidectomy_Tools_ToolInnerCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">도구 충돌 점수</th>
                                      <td>${map.anterior_ethmoidectomy_Tools_ToolTouchScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 도구 위치 점수</th>
                                      <td>${map.anterior_ethmoidectomy_Tools_ToolViewScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">각각 최대 툴 점수</th>
                                      <td>${map.anterior_ethmoidectomy_Tools_MaxScore}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content at-height">
                          <div class="row">
                              <div class="col-md-12">
                                  <h6 class="chart-top-title">전사골동 개방 도구 점수</h6>
                                  <ul class="chart-color-ul">
                                      <li><span class="chart-color one"></span>전문가 점수</li>
                                      <li><span class="chart-color two"></span>실습자 점수</li>
                                      <li><span class="chart-color three"></span>실습자 평균</li>
                              ...
                              <div class="first-chart">
                                  <div class="first-chart-container">
                                      ...
                                      new Chartist.Bar('#tool_tumor_removal_chart', {
                                          ...
                                          [${map.anterior_ethmoidectomy_Tools_TouchCount}, ${map.anterior_ethmoidectomy_Tools_ToolUseCount},
                                        	  ${map.anterior_ethmoidectomy_Tools_ToolInnerCount}, ${map.anterior_ethmoidectomy_Tools_ToolTouchScore}, 
                                        	  ${map.anterior_ethmoidectomy_Tools_ToolViewScore}, ${map.anterior_ethmoidectomy_Tools_MaxScore}],
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">전사골동 개방 핀 그래프</h6>
                          <div class="ct-chart ct-chart-bar" id="anterior_ethmoidectomy_pin_chart"></div>
                          <script>  
                          new Chartist.Line('#anterior_ethmoidectomy_pin_chart', {
                              labels: [],
                              series: [
                            	  		${map.anterior_ethmoidectomy_Pins},
                            	  		${map.anterior_ethmoidectomy_TargetPins}
                                    ]
                          }, {
                              height: 322,
                              fullWidth: true,
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          ...
                          <div style="width:250px;height:250px;padding:20px" class="mx-auto">
                              <input class="knob" data-min="0" data-max="100" data-linecap="round" data-cgColor="#d7d7d7" data-fgColor="#43b9f6" data-thickness=".2" data-readOnly=true value="${map.sc_anterior_ethmoidectomy}">
                          </div>
                      </div>
                  </div>
              </div>
