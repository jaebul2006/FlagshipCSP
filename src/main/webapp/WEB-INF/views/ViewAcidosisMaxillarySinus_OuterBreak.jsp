...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white" id="navbar">
      ...
      <main role="main">
          <section class="sub-visual evaluation">
              <div class="container">
                  <h1 class="main-visual-heading mb-0">AcidosisMaxillarySinus</h1>
              </div>
          </section>
              ...
              <div class="row">
                  <div class="col-sm-12">
                      <ol class="cd-breadcrumb triangle custom-icons">
                        ...
                        <li><a href="#" onclick="SuperiorTurbinate();">Step <strong>상악동 자연공 확장</strong></a></li>
                      </ol>
                  </div>
				  ...
				  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">Acidosis Maxillary Sinus 도구 정보</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content at-height">
                          <div class="row">
                              <div class="col-md-12">
                                  <h6 class="chart-top-title">Acidosis Maxillary Sinus 도구 점수</h6>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">Acidosis Maxillary Sinus 수술 부위 도식</h6>
          ...
          <div class="container">
               <div class="row">
                  <h4 class="title-lg text-center mb-5 mt-5">Acidosis Maxillary Sinus 전체 결과 정보 및 통계</h4>
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">Acidosis Maxillary Sinus 점수 분포 그래프</h6>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          ...
                          var chart = new Chartist.Line('.ct-chart-04', {
                              labels: ['외향골절', '구상돌기 제거', '상악동 자연공 확장'],
                              series: [
                                  [${map.sc_outer_break}, ${map.sc_uncinectomy}, ${map.sc_superior_turbinate}],
                                ]
                          }, {
                              low: 0,
                              showArea: true,
    ...
    ================================================== -->
        ...
        function OuterBreak()
        {
        	window.location.href = "${path}/ViewAcidosisMaxillarySinus_OuterBreak?id=${map.no}"; 
        }
        
        function Uncinectomy()
        {
        	window.location.href = "${path}/ViewAcidosisMaxillarySinus_Uncinectomy?id=${map.no}"; 
        }
        
        function SuperiorTurbinate()
        {
        	window.location.href = "${path}/ViewAcidosisMaxillarySinus_SuperiorTurbinate?id=${map.no}"; 
        }
