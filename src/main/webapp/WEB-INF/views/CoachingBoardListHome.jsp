              ...
              <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                      <a href="/CSP/CoachingBoard/CoachingBoardListTSA?id=${pageContext.request.remoteUser}&content_type=ENTSurgery" class="btn btn-primary btn-sm width100">나의 실습목록 보기</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                      <a href="/CSP/CoachingBoard/CoachingBoardListOS?id=${pageContext.request.remoteUser}&content_type=HIPSurgery" class="btn btn-primary btn-sm width100">나의 실습목록 보기</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="navbar-collapse collapse" id="navbarsExample07" style="">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
              <a class="nav-link" href="#">라이센스 구매</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
              <div class="col-md-12 text-center mb-5">
                  ...
                  <span class="title-sm">자신이 시뮬레이터에서 녹화한 수술 영상을 확인할 수 있습니다. 유형을 선택해주세요.</span>
              </div>
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href="/CSP/CoachingBoard/CoachingBoardListTSA?id=${pageContext.request.remoteUser}&content_type=ENTSurgery" class="btn btn-primary btn-sm">목록 보기</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href="/CSP/CoachingBoard/CoachingBoardListOS?id=${pageContext.request.remoteUser}&content_type=HIPSurgery" class="btn btn-primary btn-sm">목록 보기</a>
                    </div>
                  </div>
                </div>
              </div>
