              ...
              <div class="row">
                  <div class="col-sm-12">
                      <ol class="cd-breadcrumb triangle custom-icons">
                        ...
                        <li class="current"><a href="#" onclick="TSASuperiorTurbinate();">Step <strong>접형동개방</strong></a></li>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">상악동 자연공 확장(SuperiorTurbinate)</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">목록</th>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>${map.ent_tsa_superior_turbinate_Score}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">기록</th>
                                      <td>${map.ent_tsa_superior_turbinate_Note}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내부 콜라이더 갯수</th>
                                      <td>${map.ent_tsa_superior_turbinate_InnerTriggerCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">외부 콜라이더 갯수</th>
                                      <td>${map.ent_tsa_superior_turbinate_OuterTriggerCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내부 콜라이더 삭제 갯수</th>
                                      <td>${map.ent_tsa_superior_turbinate_InnerTriggerTouchCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">외부 콜라이더 삭제 갯수</th>
                                      <td>${map.ent_tsa_superior_turbinate_OuterTriggerTouchCount}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">상악동 자연공 확장(SuperiorTurbinate) 도구 정보</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">도구 수치 목록</th>
                              ...
                              <tbody>
                                  <tr>
                                      <th scope="row">충돌횟수</th>
                                      <td>${map.ent_tsa_superior_turbinate_Tools_TouchCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">툴 조작 횟수</th>
                                      <td>${map.ent_tsa_superior_turbinate_Tools_ToolUseCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 정확한 툴 위치횟수</th>
                                      <td>${map.ent_tsa_superior_turbinate_Tools_ToolInnerCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">도구 충돌 점수</th>
                                      <td>${map.ent_tsa_superior_turbinate_Tools_ToolTouchScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 도구 위치 점수</th>
                                      <td>${map.ent_tsa_superior_turbinate_Tools_ToolViewScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">각각 최대 툴 점수</th>
                                      <td>${map.ent_tsa_superior_turbinate_Tools_MaxScore}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content at-height">
                          <div class="row">
                              <div class="col-md-12">
                                  <h6 class="chart-top-title">상악동 자연공 확장(SuperiorTurbinate) 도구 점수</h6>
                                  <ul class="chart-color-ul">
                                      <li><span class="chart-color one"></span>전문가 점수</li>
                                      <li><span class="chart-color two"></span>실습자 점수</li>
                                      <li><span class="chart-color three"></span>실습자 평균</li>
                              ...
                              <div class="first-chart">
                                  <div class="first-chart-container">
                                      ...
                                      new Chartist.Bar('#tool_superior_turbinate_chart', {
                                          ...
                                          [${map.ent_tsa_superior_turbinate_Tools_TouchCount}, ${map.ent_tsa_superior_turbinate_Tools_ToolUseCount}, ${map.ent_tsa_superior_turbinate_Tools_ToolInnerCount}, ${map.ent_tsa_superior_turbinate_Tools_ToolTouchScore}, ${map.ent_tsa_superior_turbinate_Tools_ToolViewScore}, ${map.ent_tsa_superior_turbinate_Tools_MaxScore}],
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">Superior Turbinate 수술 부위 도식</h6>
