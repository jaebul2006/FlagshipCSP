              ...
              <div class="row">
                  <div class="col-sm-12">
                      <ol class="cd-breadcrumb triangle custom-icons">
                      	<li class="current"><a href="#" onclick="TSAOuterBreak();">Step <strong>외향골절</strong></a></li>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">외향골절(OuterBreak)</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">목록</th>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>${map.ent_tsa_outerbreak_Score}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">기록</th>
                                      <td>${map.ent_tsa_outerbreak_Note}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">position</th>
                                      <td>${map.ent_tsa_outerbreak_Position}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">rotation</th>
                                      <td>${map.ent_tsa_outerbreak_Rotation}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">scale</th>
                                      <td>${map.ent_tsa_outerbreak_Scale}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">외향골절(OuterBreak) 도구 정보</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">도구 수치 목록</th>
                              ...
                              <tbody>
                                  <tr>
                                      <th scope="row">충돌횟수</th>
                                      <td>${map.ent_tsa_outerbreak_Tools_TouchCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">툴 조작 횟수</th>
                                      <td>${map.ent_tsa_outerbreak_Tools_ToolUseCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 정확한 툴 위치횟수</th>
                                      <td>${map.ent_tsa_outerbreak_Tools_ToolInnerCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">도구 충돌 점수</th>
                                      <td>${map.ent_tsa_outerbreak_Tools_ToolTouchScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 도구 위치 점수</th>
                                      <td>${map.ent_tsa_outerbreak_Tools_ToolViewScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">각각 최대 툴 점수</th>
                                      <td>${map.ent_tsa_outerbreak_Tools_MaxScore}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content at-height">
                          <div class="row">
                              <div class="col-md-12">
                                  <h6 class="chart-top-title">외향골절(OuterBreak) 도구 점수</h6>
                                  <ul class="chart-color-ul">
                                      <li><span class="chart-color one"></span>전문가 점수</li>
                                      <li><span class="chart-color two"></span>실습자 점수</li>
                                      <li><span class="chart-color three"></span>실습자 평균</li>
                              ...
                              <div class="first-chart">
                                  <div class="first-chart-container">
                                      ...
                                      new Chartist.Bar('#tool_chart2', {
                                          ...
                                          [${map.ent_tsa_outerbreak_Tools_TouchCount}, ${map.ent_tsa_outerbreak_Tools_ToolUseCount}, ${map.ent_tsa_outerbreak_Tools_ToolInnerCount}, ${map.ent_tsa_outerbreak_Tools_ToolTouchScore}, ${map.ent_tsa_outerbreak_Tools_ToolViewScore}, ${map.ent_tsa_outerbreak_Tools_MaxScore}],
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">외향골절(OuterBreak)궤적 그래프 X</h6>
                          <div class="ct-chart ct-chart-bar" id="chart1"></div>
                          <script>
                          var ent_tsa_outerbreak_points_x = [];
                          <c:forEach var="row" items="${map.ent_tsa_outerbreak_points}">
                          	ent_tsa_outerbreak_points_x.push(${row.positionA}[0]);
  						  </c:forEach>
                          
  						  var ent_tsa_outerbreak_target_points_x = [];
  						  <c:forEach var="row" items="${map.ent_tsa_outerbreak_target_points}">
  							ent_tsa_outerbreak_target_points_x.push(${row.positionA}[0]);
						  </c:forEach>
  						  
                          new Chartist.Line('#chart1', {
                              labels: [],
                              series: [
                            	  	  ent_tsa_outerbreak_points_x,
                            	  	  ent_tsa_outerbreak_target_points_x,
                                    ]
                          }, {
                              height: 322,
                              fullWidth: true,
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">외향골절(OuterBreak)궤적 그래프 Y</h6>
                          <div class="ct-chart ct-chart-bar" id="chart2"></div>
                          <script>
                          var ent_tsa_outerbreak_points_y = [];
                          <c:forEach var="row" items="${map.ent_tsa_outerbreak_points}">
                          	ent_tsa_outerbreak_points_y.push(${row.positionA}[1]);
  						  </c:forEach>
                          
  						  var ent_tsa_outerbreak_target_points_y = [];
  						  <c:forEach var="row" items="${map.ent_tsa_outerbreak_target_points}">
  							ent_tsa_outerbreak_target_points_y.push(${row.positionA}[1]);
						  </c:forEach>
  						  
                          new Chartist.Line('#chart2', {
                              labels: [],
                              series: [
                            	  	  ent_tsa_outerbreak_points_y,
                            	  	  ent_tsa_outerbreak_target_points_y,
                                    ]
                          }, {
                              height: 322,
                              fullWidth: true,
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">외향골절(OuterBreak)궤적 그래프 Z</h6>
                          <div class="ct-chart ct-chart-bar" id="chart3"></div>
                          <script>
                          var ent_tsa_outerbreak_points_z = [];
                          <c:forEach var="row" items="${map.ent_tsa_outerbreak_points}">
                          	ent_tsa_outerbreak_points_z.push(${row.positionA}[2]);
  						  </c:forEach>
                          
  						  var ent_tsa_outerbreak_target_points_z = [];
  						  <c:forEach var="row" items="${map.ent_tsa_outerbreak_target_points}">
  							ent_tsa_outerbreak_target_points_z.push(${row.positionA}[2]);
						  </c:forEach>
  						  
                          new Chartist.Line('#chart3', {
                              labels: [],
                              series: [
                            	  	  ent_tsa_outerbreak_points_z,
                            	  	  ent_tsa_outerbreak_target_points_z,
                                    ]
                          }, {
                              height: 322,
                              fullWidth: true,
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          ...
                          <!--  <img src="./KVRF/final/images/1TSA.png" alt="수술부위도식 이미지" class="img100"> -->
                      </div>
                  </div>
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">Outer Break 점수</h6>
