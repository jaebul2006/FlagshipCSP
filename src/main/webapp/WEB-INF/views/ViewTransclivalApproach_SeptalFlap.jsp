...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white" id="navbar">
      ...
      <main role="main">
          <section class="sub-visual evaluation">
              <div class="container">
                  <h1 class="main-visual-heading mb-0">Transclival Approach</h1>
              </div>
          </section>
              ...
              <div class="row">
                  <div class="col-sm-12">
                      <ol class="cd-breadcrumb triangle custom-icons">
                      	<li><a href="#" onclick="OuterBreak();">Step <strong>외향골절</strong></a></li>
                        <li class="current"><a href="#" onclick="SeptalFlap();">Step <strong>비중격피판도안</strong></a></li>
                        <li><a href="#" onclick="SphenoidCellsRemoval();">Step 접형동개방<strong></strong></a></li>
                        <li><a href="#" onclick="TransclivalDrilling();">Step 경사대드릴링<strong></strong></a></li>
                      </ol>
                  </div>

                  <h4 class="title-lg text-center mb-5 mt-5">비중격피판도안</h4>
				  ...
				  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">Transclival Approach 도구 정보</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content at-height">
                          <div class="row">
                              <div class="col-md-12">
                                  <h6 class="chart-top-title">Transclival Approach 도구 점수</h6>
                              ...
                              <div class="first-chart">
                                  <div class="first-chart-container">
                                      ...
                                      new Chartist.Bar('#tool_chart1', {
                                          ...
                                          [${map.tools_TouchCount}, ${map.tools_ToolUseCount}, ${map.tools_ToolInnerCount}, 
                                        	  ${map.tools_ToolTouchScore}, ${map.tools_ToolViewScore}, ${map.tools_MaxScore}],
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">비중격피판도안</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">목록</th>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>${map.septalflap_Score}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">기록</th>
                                      <td>${map.septalflap_Note}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">position</th>
                                      <td>${map.septalflap_Position}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">rotation</th>
                                      <td>${map.septalflap_Rotation}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">scale</th>
                                      <td>${map.septalflap_Scale}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">비중격피판도안 도구 정보</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">도구 수치 목록</th>
                              ...
                              <tbody>
                                  <tr>
                                      <th scope="row">충돌횟수</th>
                                      <td>${map.septalflap_Tools_TouchCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">툴 조작 횟수</th>
                                      <td>${map.septalflap_Tools_ToolUseCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 정확한 툴 위치횟수</th>
                                      <td>${map.septalflap_Tools_ToolInnerCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">도구 충돌 점수</th>
                                      <td>${map.septalflap_Tools_ToolTouchScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 도구 위치 점수</th>
                                      <td>${map.septalflap_Tools_ToolViewScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">각각 최대 툴 점수</th>
                                      <td>${map.septalflap_Tools_MaxScore}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content at-height">
                          <div class="row">
                              <div class="col-md-12">
                                  <h6 class="chart-top-title">비중격피판도안 도구 점수</h6>
                                  <ul class="chart-color-ul">
                                      <li><span class="chart-color one"></span>전문가 점수</li>
                                      <li><span class="chart-color two"></span>실습자 점수</li>
                                      <li><span class="chart-color three"></span>실습자 평균</li>
                              ...
                              <div class="first-chart">
                                  <div class="first-chart-container">
                                      <div class="ct-chart ct-perfect-fourth" id="tool_septalflap_chart"></div>
                                      <script type="text/javascript">
                                      new Chartist.Bar('#tool_septalflap_chart', {
                                          labels: ['충돌횟수', '툴 조작 횟수', '내시경 화면내 정확한 툴 위치횟수', '도구 충돌 점수', '내시경 화면내 도구 위치 점수', '각각 최대 툴 점수'],
                                          series: [
                                          ...
                                          [${map.septalflap_Tools_TouchCount}, ${map.septalflap_Tools_ToolUseCount}, 
                                        	  ${map.septalflap_Tools_ToolInnerCount}, ${map.septalflap_Tools_ToolTouchScore}, 
                                        	  ${map.septalflap_Tools_ToolViewScore}, ${map.septalflap_Tools_MaxScore}],
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">비중격피판도안 궤적 그래프 X</h6>
                          <div class="ct-chart ct-chart-bar" id="septal_flap_chart_x"></div>
                          <script>
                          var septalflap_points_x = [];
                          <c:forEach var="row" items="${map.septalflap_points}">
                          	septalflap_points_x.push(${row.positionA}[0]);
  						  </c:forEach>
                          
  						  var septalflap_target_points_x = [];
  						  <c:forEach var="row" items="${map.septalflap_target_points}">
  							septalflap_target_points_x.push(${row.positionA}[0]);
						  </c:forEach>
  						  
                          new Chartist.Line('#septal_flap_chart_x', {
                              labels: [],
                              series: [
                            	  	  septalflap_points_x,
                            	  	  septalflap_target_points_x,
                                    ]
                          }, {
                              height: 322,
                              fullWidth: true,
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">비중격피판도안 궤적 그래프 Y</h6>
                          <div class="ct-chart ct-chart-bar" id="septal_flap_chart_y"></div>
                          <script>
                          var septalflap_points_y = [];
                          <c:forEach var="row" items="${map.septalflap_points}">
                          	septalflap_points_y.push(${row.positionA}[1]);
  						  </c:forEach>
                          
  						  var septalflap_target_points_y = [];
  						  <c:forEach var="row" items="${map.septalflap_target_points}">
  							septalflap_target_points_y.push(${row.positionA}[1]);
						  </c:forEach>
  						  
                          new Chartist.Line('#septal_flap_chart_y', {
                              labels: [],
                              series: [
                            	  	  septalflap_points_y,
                            	  	  septalflap_target_points_y,
                                    ]
                          }, {
                              height: 322,
                              fullWidth: true,
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">비중격피판도안 궤적 그래프 Z</h6>
                          <div class="ct-chart ct-chart-bar" id="septal_flap_chart_z"></div>
                          <script>
                          var septalflap_points_z = [];
                          <c:forEach var="row" items="${map.septalflap_points}">
                          	septalflap_points_z.push(${row.positionA}[2]);
  						  </c:forEach>
                          
  						  var septalflap_target_points_z = [];
  						  <c:forEach var="row" items="${map.septalflap_target_points}">
  							septalflap_target_points_z.push(${row.positionA}[2]);
						  </c:forEach>
  						  
                          new Chartist.Line('#septal_flap_chart_z', {
                              labels: [],
                              series: [
                            	  	  septalflap_points_z,
                            	  	  septalflap_target_points_z,
                                    ]
                          }, {
                              height: 322,
                              fullWidth: true,
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          ...
                          <div style="width:250px;height:250px;padding:20px" class="mx-auto">
                              <input class="knob" data-min="0" data-max="100" data-linecap="round" data-cgColor="#d7d7d7" data-fgColor="#43b9f6" data-thickness=".2" data-readOnly=true value="${map.sc_septal_flap}">
                          </div>
                      </div>
                  </div>
          ...
          <div class="container">
               <div class="row">
                  <h4 class="title-lg text-center mb-5 mt-5">Transclival Approach 전체 결과 정보 및 통계</h4>
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">Transclival Approach 점수 분포 그래프</h6>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          ...
                          var chart = new Chartist.Line('.ct-chart-04', {
                              labels: ['외향골절', '비중격피판도안', '접형동개방', '경사대드릴링'],
                              series: [
                                  [${map.sc_outer_break}, ${map.sc_septal_flap}, ${map.sc_sphenoid_cells_removal}, ${map.sc_transclival_drilling}],
                                ]
                          }, {
                              low: 0,
                              showArea: true,
    ...
    ================================================== -->
        ...
        function OuterBreak()
        {
        	window.location.href = "${path}/ViewTransclivalApproach_OuterBreak?id=${map.no}"; // tsa id 로 보내야됨
        }
        
        // 2. SeptalFlap
        function SeptalFlap()
        {
        	window.location.href = "${path}/ViewTransclivalApproach_SeptalFlap?id=${map.no}";
        }
        
        function SphenoidCellsRemoval()
        {
        	window.location.href = "${path}/ViewTransclivalApproach_SphenoidCellsRemoval?id=${map.no}";
        }
        
        function TransclivalDrilling()
        {
        	window.location.href = "${path}/ViewTransclivalApproach_TransclivalDrilling?id=${map.no}";
        }
