    ...
    <nav class="navbar navbar-expand-lg bg-white" id="navbar">
      ...
      <main role="main">
          <section class="sub-visual evaluation">
              <div class="container">
                  <h1 class="main-visual-heading mb-0">Acidosis Maxillary Sinus</h1>
              </div>
          </section>
              ...
              <div class="row">
                  <div class="col-sm-12">
                      <ol class="cd-breadcrumb triangle custom-icons">
                        ...
                        <li class="current"><a href="#" onclick="SuperiorTurbinate();">Step <strong>상악동 자연공 확장</strong></a></li>
                      </ol>
                  </div>

                  <h4 class="title-lg text-center mb-5 mt-5">상악동 자연공 확장</h4>
                              ...
                              <div class="first-chart">
                                  <div class="first-chart-container">
                                      ...
                                      new Chartist.Bar('#tool_chart1', {
                                          ...
                                          [${map.tools_TouchCount}, ${map.tools_ToolUseCount}, ${map.tools_ToolInnerCount}, ${map.tools_ToolTouchScore}, ${map.tools_ToolViewScore}, ${map.tools_MaxScore}],
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">상악동 자연공 확장</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">목록</th>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>${map.superior_turbinate_Score}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">기록</th>
                                      <td>${map.superior_turbinate_Note}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내부 콜라이더 갯수</th>
                                      <td>${map.superior_turbinate_InnerTriggerCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">외부 콜라이더 갯수</th>
                                      <td>${map.superior_turbinate_OuterTriggerCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내부 콜라이더 삭제 갯수</th>
                                      <td>${map.superior_turbinate_InnerTriggerTouchCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">외부 콜라이더 삭제 갯수</th>
                                      <td>${map.superior_turbinate_OuterTriggerTouchCount}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">상악동 자연공 확장 도구 정보</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">도구 수치 목록</th>
                              ...
                              <tbody>
                                  <tr>
                                      <th scope="row">충돌횟수</th>
                                      <td>${map.superior_turbinate_Tools_TouchCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">툴 조작 횟수</th>
                                      <td>${map.superior_turbinate_Tools_ToolUseCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 정확한 툴 위치횟수</th>
                                      <td>${map.superior_turbinate_Tools_ToolInnerCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">도구 충돌 점수</th>
                                      <td>${map.superior_turbinate_Tools_ToolTouchScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 도구 위치 점수</th>
                                      <td>${map.superior_turbinate_Tools_ToolViewScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">각각 최대 툴 점수</th>
                                      <td>${map.superior_turbinate_Tools_MaxScore}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content at-height">
                          <div class="row">
                              <div class="col-md-12">
                                  <h6 class="chart-top-title">상악동 자연공 확장 도구 점수</h6>
                                  <ul class="chart-color-ul">
                                      <li><span class="chart-color one"></span>전문가 점수</li>
                                      <li><span class="chart-color two"></span>실습자 점수</li>
                                      <li><span class="chart-color three"></span>실습자 평균</li>
                              ...
                              <div class="first-chart">
                                  <div class="first-chart-container">
                                      <div class="ct-chart ct-perfect-fourth" id="tool_superior_turbinate_chart"></div>
                                      <script type="text/javascript">
                                      new Chartist.Bar('#tool_superior_turbinate_chart', {
                                          labels: ['충돌횟수', '툴 조작 횟수', '내시경 화면내 정확한 툴 위치횟수', '도구 충돌 점수', '내시경 화면내 도구 위치 점수', '각각 최대 툴 점수'],
                                          series: [
                                          ...
                                          [${map.superior_turbinate_Tools_TouchCount}, ${map.superior_turbinate_Tools_ToolUseCount}, ${map.superior_turbinate_Tools_ToolInnerCount}, ${map.superior_turbinate_Tools_ToolTouchScore}, ${map.superior_turbinate_Tools_ToolViewScore}, ${map.superior_turbinate_Tools_MaxScore}],
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          ...
                          <div style="width:250px;height:250px;padding:20px" class="mx-auto">
                              <input class="knob" data-min="0" data-max="100" data-linecap="round" data-cgColor="#d7d7d7" data-fgColor="#43b9f6" data-thickness=".2" data-readOnly=true value="${map.sc_superior_turbinate}">
                          </div>
                      </div>
                  </div>
          ...
          <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">단위수술점수 그래프</h6>
                          <ul class="chart-color-ul">
