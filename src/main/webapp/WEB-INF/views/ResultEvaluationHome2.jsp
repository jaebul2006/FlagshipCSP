        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 sub-nav-wrap-inner clear-after">
                    ...
                    <div class="sub-nav-list"><a href="/CSP/Ent_Expert_Tools"><h3 class="sub-nav-title">수술 평가(전문가점수 편집)</h3></a></div>
                </div>
            </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row flexbox-container">
              <div class="col-md-12 text-center mb-5">
                  <span class="title-sm">세부 수술 평가 유형을 선택해주세요.</span>
              </div>
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="./KVRF/final/images/thum01.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="mb-4">TSA</h5>
                  <div class="d-flex justify-content-between align-items-center">
                      <a href="/CSP/TSAList?id=${pageContext.request.remoteUser}&oper_name=ent_tsa" class="btn btn-primary btn-sm width100">나의 실습목록 보기</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="./KVRF/final/images/thum01.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="mb-4">Transclival Approach</h5>
                  <div class="d-flex justify-content-between align-items-center">
                      <a href="/CSP/TransclivalApproachList?id=${pageContext.request.remoteUser}&oper_name=ent_transclival_approach" class="btn btn-primary btn-sm width100">나의 실습목록 보기</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="./KVRF/final/images/thum01.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="mb-4">Acidosis Maxillary Sinus</h5>
                  <div class="d-flex justify-content-between align-items-center">
                      <a href="/CSP/AcidosisMaxillarySinusList?id=${pageContext.request.remoteUser}&oper_name=ent_acidosis_maxillary_sinus" class="btn btn-primary btn-sm width100">나의 실습목록 보기</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="./KVRF/final/images/thum01.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="mb-4">Acidosis Frontal Sinus</h5>
                  <div class="d-flex justify-content-between align-items-center">
                      <a href="/CSP/AcidosisFrontalSinusList?id=${pageContext.request.remoteUser}&oper_name=ent_acidosis_frontal_sinus" class="btn btn-primary btn-sm width100">나의 실습목록 보기</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="./KVRF/final/images/thum01.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="mb-4">Acidosis Ethmoidal Sinus</h5>
                  <div class="d-flex justify-content-between align-items-center">
                      <a href="/CSP/AcidosisEthmoidalSinusList?id=${pageContext.request.remoteUser}&oper_name=ent_acidosis_ethmoidal_sinus" class="btn btn-primary btn-sm width100">나의 실습목록 보기</a>
                  </div>
                </div>
              </div>
            </div>
