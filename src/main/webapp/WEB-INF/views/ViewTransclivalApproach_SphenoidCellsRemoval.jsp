              ...
              <div class="row">
                  <div class="col-sm-12">
                      <ol class="cd-breadcrumb triangle custom-icons">
                        ...
                        <li class="current"><a href="#" onclick="SphenoidCellsRemoval();">Step <strong>접형동개방</strong></a></li>
                        <li><a href="#" onclick="TransclivalDrilling();">Step <strong>경사대드릴링</strong></a></li>
                      </ol>
                  </div>

                  <h4 class="title-lg text-center mb-5 mt-5">접형동개방</h4>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">접형동개방</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">목록</th>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>${map.sphenoid_cells_removal_Score}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">기록</th>
                                      <td>${map.sphenoid_cells_removal_Note}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">Position</th>
                                      <td>${map.sphenoid_cells_removal_Position}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">Rotation</th>
                                      <td>${map.sphenoid_cells_removal_Rotation}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">Localcale</th>
                                      <td>${map.sphenoid_cells_removal_Localcale}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">핀 갯수</th>
                                      <td>${map.sphenoid_cells_removal_PinCount}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">접형동개방 도구 정보</h6>
                          <table class="table ev-tbl">
                              <thead class="thead-dark">
                                  <tr>
                                      <th scope="col">도구 수치 목록</th>
                              ...
                              <tbody>
                                  <tr>
                                      <th scope="row">충돌횟수</th>
                                      <td>${map.sphenoid_cells_removal_Tools_TouchCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">툴 조작 횟수</th>
                                      <td>${map.sphenoid_cells_removal_Tools_ToolUseCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 정확한 툴 위치횟수</th>
                                      <td>${map.sphenoid_cells_removal_Tools_ToolInnerCount}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">도구 충돌 점수</th>
                                      <td>${map.sphenoid_cells_removal_Tools_ToolTouchScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">내시경 화면내 도구 위치 점수</th>
                                      <td>${map.sphenoid_cells_removal_Tools_ToolViewScore}</td>
                                  </tr>
                                  <tr>
                                      <th scope="row">각각 최대 툴 점수</th>
                                      <td>${map.sphenoid_cells_removal_Tools_MaxScore}</td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content at-height">
                          <div class="row">
                              <div class="col-md-12">
                                  <h6 class="chart-top-title">접형동개방 도구 점수</h6>
                                  <ul class="chart-color-ul">
                                      <li><span class="chart-color one"></span>전문가 점수</li>
                                      <li><span class="chart-color two"></span>실습자 점수</li>
                                      <li><span class="chart-color three"></span>실습자 평균</li>
                              ...
                              <div class="first-chart">
                                  <div class="first-chart-container">
                                      ...
                                      new Chartist.Bar('#tool_tumor_removal_chart', {
                                          ...
                                          [${map.sphenoid_cells_removal_Tools_TouchCount}, ${map.sphenoid_cells_removal_Tools_ToolUseCount},
                                        	  ${map.sphenoid_cells_removal_Tools_ToolInnerCount}, ${map.sphenoid_cells_removal_Tools_ToolTouchScore}, 
                                        	  ${map.sphenoid_cells_removal_Tools_ToolViewScore}, ${map.sphenoid_cells_removal_Tools_MaxScore}],
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">접형동개방 핀 그래프</h6>
                          <div class="ct-chart ct-chart-bar" id="sphenoid_cells_removal_pin_chart"></div>
                          <script>  
                          new Chartist.Line('#sphenoid_cells_removal_pin_chart', {
                              labels: [],
                              series: [
                            	  		${map.sphenoid_cells_removal_Pins},
                            	  		${map.sphenoid_cells_removal_TargetPins}
                                    ]
                          }, {
                              height: 322,
                              fullWidth: true,
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          <h6 class="chart-top-title">Sphenoid Cells Removal 수술 부위 도식</h6>
                  ...
                  <div class="col-md-6 col-sm-12">
                      <div class="chart-inner-content">
                          ...
                          <div style="width:250px;height:250px;padding:20px" class="mx-auto">
                              <input class="knob" data-min="0" data-max="100" data-linecap="round" data-cgColor="#d7d7d7" data-fgColor="#43b9f6" data-thickness=".2" data-readOnly=true value="${map.sc_sphenoid_cells_removal}">
                          </div>
                      </div>
                  </div>
              </div>
